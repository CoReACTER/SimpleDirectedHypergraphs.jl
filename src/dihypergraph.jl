...
function DirectedHypergraph{T,V,E,D}(
    ...
    n, k = size(hg_tail)
    shg_tail = Hypergraph(n, k)
    shg_head = Hypergraph(n, k)
...
function DirectedHypergraph{T,V,E,D}(
    ...
    hg_tail = Hypergraph{T,D}(n, k)
    hg_tail .= m_tail
    
    hg_head = Hypergraph{T,D}(n, k)
    hg_head .= m_head
...
function DirectedHypergraph{T,V,E}(
    ...
    hg_tail = Hypergraph{T,Dict{Int,T}}(n, k)
    hg_tail .= m_tail

    hg_head = Hypergraph{T,Dict{Int,T}}(n, k)
    hg_head .= m_head
