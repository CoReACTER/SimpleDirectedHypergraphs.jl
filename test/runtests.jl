...
@testset "SimpleDirectedHypergraphs io                     " begin
    ...
    mktemp("data") do path, _
        ...
        @test loaded_hg ==
            ...
            init = read("data/test_dhg.ehgf", String)
        ) #no comments
        ...
        @test loaded_hg ==
            ...
            init = read("data/singlelinecomment.ehgf", String)
        ) #single line comment
        ...
        @test loaded_hg ==
            ...
            init = read("data/multilinecomment.ehgf", String)
